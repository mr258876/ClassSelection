				...
				<table width="955px" align="center" cellspacing="0">
					...
					<tr>
						<td width="34" height="30" valign="middle">&nbsp;
							<span class="STYLE1"><img src="images/jiantou.jpg" width="15" height="17" /></span>
						</td>
						...
						<td width="500">
							<html:form action="/updatePwd.do?type=m">
								<table cellspacing="1" bgcolor="#c2d3b0">
									<tr>
										<td height="24" colspan="3" align="center" bgcolor="#FFFFFF" class="STYLE1">
											${error}</td>
									</tr>
									<tr>
										<td width="65" height="30" bgcolor="#f8fcf3" class="td0">登录帐号：</td>
										<td width="185" bgcolor="#FFFFFF">&nbsp;
											<html:text property="loginName" value="${loginName}" readonly="true" />
										</td>
